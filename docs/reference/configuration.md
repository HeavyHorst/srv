...
| `SRV_AMP_CONNECT_GATEWAY_PORT` | `3128` | Per-VM HTTP CONNECT gateway for public HTTPS destinations on port 443; private, local, and special-use networks are blocked |
